(function () {
	...
	function float(id) {
		...
		target.style.top = (document.documentElement.scrollTop + document.documentElement.clientHeight + offset) + 'px';
