                ...
                <?php else: ?>
                    <p class="<?php echo $common_row['type']; ?>">
                        <?php foreach ($common_row['urls'] as $common_url): ?>
                            <span class="urlspan" >
                                <a href="<?php echo $common_url['url']; ?>" target="_blank" onmousedown="$(this).attr('href','./index.php/c/jmpc?uid=<?php echo $common_url['uid']; ?>&url=<?php echo $common_url['url']; ?>')">
                        ...
                        <div class="url-class-area">
                            <?php foreach ($class['urls'] as $url): ?>
                                <span class="urlspan2 <?php echo $url['style']; ?>" title="<?php echo $url['content']; ?>">
                                    <a href="<?php echo $url['url']; ?>" target="_blank" onmousedown="$(this).attr('href','http://localhost/CodeIgniterTest/index.php/c/jmp?uid=59&url=<?php echo $url['url']; ?>')"><?php echo $url['name']; ?></a>
                                </span>
                            <?php endforeach; ?>
                        </div>
                        <div class="clear"> </div>
